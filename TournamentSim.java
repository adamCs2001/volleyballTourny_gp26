        ...
        private ArrayList<String> createScore()
        {
            ...
            Random rand = new Random();
                for (int i = 0; i < 5; i++)
                {
                    ...
                    if (rand.nextInt(2) == 0)
                    {
                        score1.concat(Integer.toString(maxScore) + ",");
                        score2.concat(Integer.toString(rand.nextInt(maxScore)) + ",");
                        point1++;
                    }
                    else 
                    {
                        score2.concat(Integer.toString(maxScore) + ",");
                        score1.concat(Integer.toString(rand.nextInt(maxScore)) + ",");
                        point2++;
                    }
